        ...
        <div className="space-y-8">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-muted-foreground">
              Find answers to the most common questions about Tonemify.
            </p>
          </div>
          <Accordion type="single" collapsible className="space-y-4">
            ...
            >
              ...
              <AccordionContent className="text-muted-foreground px-4 leading-relaxed">
                ...
                you&apos;re satisfied with your new cool theme, save it for
                future use.
                <br />
                <br />
            ...
            >
              ...
              <AccordionContent className="text-muted-foreground px-4 leading-relaxed">
                Yes, Tonemify has built-in dark mode support to ensure your
                themes look great in both light and dark environments.
              </AccordionContent>
            </AccordionItem>
            ...
            >
              ...
              <AccordionContent className="text-muted-foreground px-4 leading-relaxed">
                Tonemify is free and opensource but if you enjoy using it and
                want to support the project, you can buy me a beer (or coffee)!
                ...
                <div className="mt-4">
                  ...
                  project, feel free to check out the GitHub repository and
                  submit a pull request. Your contributions are greatly
                  appreciated!
                  <Link
