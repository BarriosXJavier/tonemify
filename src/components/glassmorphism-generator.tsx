  ...
  return (
    <div className="flex flex-col lg:flex-row gap-8 p-4 md:p-8">
      ...
      <div className="flex-1">
        ...
        >
          <div className="w-64 h-40 rounded-lg" style={getPreviewStyle()}></div>
        </div>
        <pre className="w-full h-32 p-2 border rounded-md bg-card text-card-foreground overflow-auto">
          {generatedCss}
        </pre>
      </div>
    </div>
